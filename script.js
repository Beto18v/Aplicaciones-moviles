...
document.querySelectorAll(".tab").forEach((tab) => {
  tab.addEventListener("click", () => {
    ...
    document
      .getElementById(`${tab.dataset.tab}-seccion`)
      ...
      data.data.forEach((paciente) => {
        ...
        div.innerHTML = `
                ...
                <div class="item-acciones">
                    ...
                    <button class="btn-eliminar" onclick="eliminarPaciente(${
                      paciente.id
                    })">
...
function cambiarEstadoCita(id) {
  ...
  if (
    !nuevoEstado ||
    !["pendiente", "completada", "cancelada"].includes(nuevoEstado)
  )
    return;
...
function mostrarModal(tipo, datos) {
  ...
  if (tipo === "paciente") {
    formulario.innerHTML = `
            ...
            <input type="text" id="edit-documento" value="${
              datos.documento
            }" placeholder="Documento">
            <input type="text" id="edit-telefono" value="${
              datos.telefono
            }" placeholder="Teléfono">
            <input type="email" id="edit-correo" value="${
              datos.correo || ""
            }" placeholder="Correo">
    ...
    formulario.innerHTML = `
            ...
            <input type="text" id="edit-odontologo" value="${
              datos.odontologo
            ...
            <select id="edit-estado">
                ...
                <option value="completada" ${
                  datos.estado === "completada" ? "selected" : ""
                }>Completada</option>
                <option value="cancelada" ${
                  datos.estado === "cancelada" ? "selected" : ""
                }>Cancelada</option>
            </select>
